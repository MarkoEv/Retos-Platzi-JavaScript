...
describe('Reto: 1 Arrays en JavaScript', () => {
  ...
  describe('Reto 2: Crear Array Mixto', () => {
  ...
  describe('Reto 3: obtenerPrimerElemento', () => {
  ...
  describe('Reto 4: obtenerUltimoElemento', () => {
  ...
  describe('Reto 5: agregarAlFinal', () => {
  ...
  describe('Reto 6: agregarAlInicio', () => {
  ...
  describe('Reto 7: insertarEnPosicion', () => {
  ...
  describe('Reto 8: reemplazarEnPosicion', () => {
  ...
  describe('Reto 9: eliminarUltimo', () => {
  ...
  describe('Reto 10: eliminarPrimero', () => {
  ...
  describe('Reto 11: eliminarEnPosicion', () => {
  ...
  describe('Reto 12: obtenerLongitud', () => {
  ...
  describe('Reto 13: encontrarIndice', () => {
